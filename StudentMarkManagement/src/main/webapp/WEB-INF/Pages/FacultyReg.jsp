...
<div class="row">
	<div class="col-md-4"></div>
	<div class="col-md-4" style="padding-top:10px">
		<span style="color: white;text-decoration:none;font-weight: bold;">Click here to see Faculty List >> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button style="background-color: black;"><a href="facultylist" style="color: white;text-decoration:none;font-weight: bold;">Faculty List</a></button></span>
	</div>
	<div class="col-md-4"></div>
</div>
</body>
